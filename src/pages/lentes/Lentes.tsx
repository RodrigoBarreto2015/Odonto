    ...
    <div className="container-lente" >
      ...
      <ScrollAnimation animateIn="fadeIn">
        <section className="beneficios">
          ...
          <ScrollAnimation animateIn="pulse">
            <img src="https://www.clinicaodontoup.com.br/images/servicos/lente-de-contato-dental-01.webp" className="img-fluid rounded" alt="Sorriso lente de contato" />
          </ScrollAnimation>
          <ul>
      ...
      <ScrollAnimation animateIn="fadeIn">
        <section className="funcionamento">
          ...
          <ScrollAnimation animateIn="pulse">
            <img src="https://www.clinicaodontoup.com.br/images/servicos/lente-de-contato-dental-02.webp" className="img-fluid rounded" alt="Instalando lente de contato" />
          </ScrollAnimation>
          <ul>
